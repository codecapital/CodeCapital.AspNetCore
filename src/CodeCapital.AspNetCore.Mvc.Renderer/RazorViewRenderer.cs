...
namespace CodeCapital.AspNetCore.Mvc.Renderer
{
    public class RazorViewRenderer
    {
        ...
        public Task<string> RenderToStringAsync(string viewName)
            => RenderToStringAsync(viewName, string.Empty);

        private IView FindView(ActionContext actionContext, string viewName)
        {
            var getViewResult = _viewEngine.GetView(executingFilePath: string.Empty, viewPath: viewName, isMainPage: true);
